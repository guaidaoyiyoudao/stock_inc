...
object DatabaseModule {
    ...
    @Provides
    fun provideFinancialStatementsCacheDao(db: AppDatabase): FinancialStatementsCacheDao =
        db.financialStatementsCacheDao()

    @Provides
    fun provideGridPlanDao(db: AppDatabase): GridPlanDao = db.gridPlanDao()
    ...
    @Provides
    fun provideFuyaoCacheDao(db: AppDatabase): com.stock.dividend.data.local.dao.FuyaoCacheDao =
        db.fuyaoCacheDao()
